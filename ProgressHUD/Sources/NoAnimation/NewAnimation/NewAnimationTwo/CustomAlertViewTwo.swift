...
final class CustomAlertViewTwo: UIView {
    ...
    init(iconName: String, titleLabelText: String, subtitleLabelText: String, descriptionFirstLabelText: String, descriptionSecondLabelText: String, descriptionLowLabelText: String, goButtonText: String) {
