...
final class CustomAlertViewThree: UIView {
    ...
    init(iconName: String, titleLabelText: String, descriptionFirstLabelText: String, descriptionSecondLabelText: String, goButtonText: String) {
